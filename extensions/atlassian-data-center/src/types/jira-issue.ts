...
/**
 * Jira Issue Fields (excluding custom fields)
 */
 ...
 */
export interface JiraIssueAvatarUrls {
  "48x48": string;
  "24x24": string;
  "16x16": string;
  "32x32": string;
 ...
 */
export interface JiraIssueParentIssue {
  id: string;
  key: string;
  self: string;
  fields: {
 ...
 */
export interface JiraIssueTimeTracking {
  timeSpent: string;
 ...
 */
export interface JiraIssueVersion {
  self: string;
  id: string;
  name: string;
  description?: string;
 ...
 */
export interface JiraIssueVotes {
  self: string;
  votes: number;
  hasVoted: boolean;
}
 ...
 */
export interface JiraIssueWatches {
  self: string;
  watchCount: number;
  isWatching: boolean;
}
 ...
 */
export interface JiraIssueWorklogEntry {
  self: string;
  author: JiraIssueUser;
  updateAuthor: JiraIssueUser;
  comment: string;
